...
import net.fishstack.fishsgadgets.item.custom.CoolerStaff;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> COOLER_STAFF = ITEMS.register("cooler_staff",
            () -> new CoolerStaff(new Item.Properties().stacksTo(1)));
